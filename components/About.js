        ...
        <div>
            ...
            <div className={styles.section}>
                <div className={styles.contentContainer}>
                    <div className={`${styles.content} ${styles.oj}`}>
                    ...
                    <div className={`${styles.content} ${styles.pj}`}>
                        <img className={styles.aboutImg}
                        src='https://images03.nicepage.com/a1389d7bc73adea1e1c1fb7e/a3cdd3e161af5b708cd928e0/pexelsphoto428355.jpeg'></img>
                    </div>
                    <div className={styles.content}>
                        <p>We anticipate the cooler weather game of venison and quail, root vegetables and greens; the first springtime shad roe and 
